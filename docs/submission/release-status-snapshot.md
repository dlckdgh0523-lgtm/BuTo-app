...
- Generated at: `2026-03-10T06:42:52.255Z`
...
- Recommended bundle: `release-status-bundle-check`
- Reason: runtime readiness blocker 8건이 남아 있어요.
- Reason: 필수 제출 파일이 모두 들어 있어요.
- Reason: 현재 runtime readiness와 번들 상태가 일치해요.
- Reason: BLOCK 8 · WARN 2 기준으로 가장 보수적인 후보예요.

## Recommended Candidate

- Status: `ACTION_REQUIRED`
- Bundle: `release-status-bundle-check`
- Reason: 필수 제출 파일이 모두 들어 있어요.
- Reason: 현재 runtime readiness와 번들 상태가 일치해요.
- Reason: BLOCK 8 · WARN 2 기준으로 가장 보수적인 후보예요.

## Recent Bundle Health

- `release-status-bundle-check` · ACTION_REQUIRED · integrity COMPLETE · drift IN_SYNC · BLOCK 8 / WARN 2
- `release-status-preflight-check` · ACTION_REQUIRED · integrity COMPLETE · drift IN_SYNC · BLOCK 8 / WARN 2
- `owner-env-rehearsal` · ACTION_REQUIRED · integrity INCOMPLETE · drift IN_SYNC · BLOCK 8 / WARN 2
- `rc-rehearsal` · ACTION_REQUIRED · integrity INCOMPLETE · drift IN_SYNC · BLOCK 8 / WARN 2
- `staging-preflight` · ACTION_REQUIRED · integrity INCOMPLETE · drift IN_SYNC · BLOCK 8 / WARN 2
...
- `docs/submission/bundles/release-status-bundle-check`
- `docs/submission/bundles/release-status-preflight-check`
